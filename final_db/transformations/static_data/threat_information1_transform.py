"""
Threat Information transformation (static dataset — uses NULL for missing fields)
All mapped fields are prefixed with `threatinfo_` to avoid collisions in the final merged table.
"""
...
# Final schema for Threat Information dataset
THREATINFO_FINAL_COLUMNS = [
    "cve_id",
    "threatinfo1_apt_group",
    "threatinfo1_source",  # provenance marker
]
...
def clean_and_rename(record: Dict[str, Any]) -> Dict[str, Any]:
    """
    Clean and rename Threat Information dataset records.
    - Normalizes CVE IDs.
    ...
    # ✅ Map → prefixed schema
    rename_map = {
        "APT group": "threatinfo1_apt_group",
    }
    ...
    out["threatinfo1_source"] = "threat_information1"

    # ✅ Fill missing columns with None
    for col in THREATINFO_FINAL_COLUMNS:
